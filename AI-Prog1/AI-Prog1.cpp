// AI-Prog1.cpp : Defines the entry point for the console application.
//

#include "stdafx.h"  // I just quickly started this project in VS15, and inadvertently added a precompiled header to the project. "stdafx.h" is an artifact of this. Please disregard.
#include <iostream>
#include <vector>
#include <string>
#include <fstream>
